...
export class IndexBuilder {
    ...
    async createIndexForFolder(folder) {
        if (!this.project) {
...
${list}
    ...
    async addFilesToRepository(repo, files, branch = 'main') {
        try {
            ...
            core.info(`Files successfully added to repository ${repo} on branch ${branch}.`);
        }
        catch (error) {
