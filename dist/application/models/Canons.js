...
export class CanonData {
    ...
    getIsValid(canon, book, chapter, verse) {
        if (this._name !== canon) {
...
export const CANON_NAMES = ['OT', 'NT', 'LXX'];
export const CANONS = [OT, NT, LXX];
export const ALL_BOOK_CODES = OT.books.concat(NT.books.concat(LXX.books));
export function canonicalOrderSort(a, b) {
