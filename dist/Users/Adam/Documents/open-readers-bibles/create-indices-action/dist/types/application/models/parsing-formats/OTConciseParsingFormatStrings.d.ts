...
export declare const OTConciseStringLabels: {
    noun_abbreviation: string;
    interrogative_abbreviation: string;
    emphatic_abbreviation: string;
    pronominal_suffix_abbreviation: string;
...
export declare const OTBasicEnglish: OTConciseParsingFormatStrings;
export declare const OTBasicPersian: OTConciseParsingFormatStrings;
